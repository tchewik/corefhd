...
class PretrainedTransformerEmbedder(TokenEmbedder):
    ...
    def forward(
        ...
        fold_long_sequences = (not self._model_name.startswith('studio-ousia/mluke')) and (
        ...
        if entity_attention_mask is not None:
            parameters["entity_attention_mask"] = entity_attention_mask
        if entity_position_ids is not None:
            parameters["entity_position_ids"] = entity_position_ids
